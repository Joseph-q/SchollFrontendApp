...
export class UpdateStudentForm {
  private form: FormGroup<IUpdateStudentForm>;
  ...
  constructor() {
    this.form = new FormGroup<IUpdateStudentForm>(
      {
  ...
  public get Form(): FormGroup<IUpdateStudentForm> {
    return this.form;
  }
  ...
  public get StudentToUpdate(): UpdateStudentRequest {
    ...
    return {
      ...
      coursesId: this.course?.value ? [this.course.value] : undefined,
